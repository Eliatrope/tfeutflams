		...
		<?php
			...
			?>
				<form action="insert.php" method="POST">
					<button name="table" value="seo" class="buttoninsert">Insérer un nouvel élément</button>
				</form>
					...
					foreach($seo as $s){
						echo 
							'<tr>'.
								...
								'</td>'.
								'<td>'.
									'<form action="edit.php" method="POST"><input class="actioning editimg" type="submit" name="submit" value=""/><input type="hidden" name="table" value="seo" /><input type="hidden" name="id" value="'.$s->id.'" /></form>'.
									'<form action="delete.php" method="POST"><input class="actioning deleteimg" type="submit" name="submit" value=""/><input type="hidden" name="table" value="seo" /><input type="hidden" name="id" value="'.$s->id.'" />
									</form>'.
								'</td>'.
							'</tr>'
						;
