		...
		<?php
			...
			?>
				<form action="insert.php" method="POST">
					<button name="table" value="galerie_photo" class="buttoninsert">Insérer un nouvel élément</button>
				</form>
			...
			<?php
					...
					foreach($galerie as $g){
						echo 
							'<tr>'.
								'<td>'.
									'<img src="../assets/images/galerie/'.$g->img.'" />'.
								'</td>'.
								'<td>'.
									$g->title.
								'</td>'.
								...
								'</td>'.
								'<td>'.
									'<form action="edit.php" method="POST"><input class="actioning editimg" type="submit" name="submit" value=""/><input type="hidden" name="table" value="galerie_photo" /><input type="hidden" name="id" value="'.$g->id.'" /></form>'.
									'<form action="delete.php" method="POST"><input class="actioning deleteimg" type="submit" name="submit" value=""/><input type="hidden" name="table" value="galerie_photo" /><input type="hidden" name="id" value="'.$g->id.'" />
									</form>'.
								'</td>'.
							'</tr>'
						;
